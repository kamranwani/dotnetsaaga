...
internal class Account
{
    ...
    public decimal Balance { get; private set; } = 10000.00m;
    ...
    public void Withdrawal(decimal amount)
    {
        if (amount > 0 && amount <= Balance)
        {
            ...
            _totalBankFunds -= amount;
            Console.WriteLine($"{_totalBankFunds} {Balance}");
